...
with open('.\\corpus_varie\\leviathan', 'rt', encoding='UTF8') as f:
    bb = f.read()
c_text = str(bb.lower())
...
# fd_regex = nltk.FreqDist([(vs) for mot in texte_sans_sw for vs in re.findall(r'\b(_[a-zéâàêèîëôöüùû]*[a-za-zéàêôèîëùöü]*_)|(\b[a-za-zéàêôèîëùöü]*--[a-za-zéàêôèîëùöü]*)', mot)])
